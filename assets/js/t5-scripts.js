...
$(document).ready(function () {
    initDiamant();
    (function ($) {
        $('.experiencia-categories').on('click', '.category-link', function (e) {
            e.preventDefault();
            var targetPanelId = $(this).data('target');
            $(targetPanelId).removeClass('d-none');
            setTimeout(() => {
                $(targetPanelId).removeClass('product-out');
                $(targetPanelId).addClass('product-in');
                $('.experiencia-categories').addClass('category-out');
            }, 100);
            setTimeout(() => {
                $(targetPanelId).mouseleave(function() {
                    $('.experiencia-categories').removeClass('category-in').removeClass('category-out');
                    $(targetPanelId).removeClass('product-in').addClass('product-out').addClass('d-none');
                });
            }, 1000);
        });
        $('.return-button').on('click', function (e) {
            ...
            var targetPanelId = $(this).data('target');
            setTimeout(() => {
                $(targetPanelId).removeClass('product-in').addClass('product-out');
                $('.experiencia-categories').removeClass('category-out').addClass('category-in');
            }, 100);
            
            setTimeout(() => {
                $('.experiencia-categories').mouseleave(function() {
                    $('.experiencia-categories').removeClass('category-in');
                });
            }, 1000);
        });
    })(jQuery);
